...
items12 = Item(name='portfolio', url='https://github.com/yogykwan/portfolio', user_id=1)
session.add(items12)
session.commit()
...
items21 = Item(name='multi-user-blog', url='https://github.com/yogykwan/multi-user-blog', user_id=1)
session.add(items21)
session.commit()
